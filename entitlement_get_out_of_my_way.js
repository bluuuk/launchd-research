...
// utility methods
const xpc_copy_description = new NativeFunction(Module.findExportByName(null, "xpc_copy_description"), 'pointer', ['pointer']);
const xpc_connection_get_pid = new NativeFunction(Module.getExportByName(null,"xpc_connection_get_pid"),"int",["pointer"]);
const xpc_bool_get_value = new NativeFunction(Module.findExportByName(null, "xpc_bool_get_value"),'bool', ['pointer']);
const xpc_bool_create = new NativeFunction(Module.findExportByName(null, "xpc_bool_create"),'pointer', ['bool']);
...
["SecTaskCopyValueForEntitlement","SecTaskCopyValuesForEntitlements"].forEach(function(fun_name){
	const nfunc = new NativeFunction(
		Module.getExportByName(null,fun_name),
		"pointer",
		["pointer","pointer","pointer"]
	);
